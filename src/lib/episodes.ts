...
export const EPISODES: Episode[] = [
  ...
  { ep: 51, title: "Can Seaweed Replace Plastic?", description: "How ocean-grown feedstocks could reshape everyday packaging.", guest: "Neha Jain", role: "Materials Innovator", category: "Environment", duration: "41 min", date: "Apr 2026", thumbnail: "/images/about_art.png" },
  ...
  { ep: 49, title: "This Artist Is Cleaning the Planet", description: "Turning waste into monumental art that moves people to act.", guest: "Benjamin Von Wong", role: "Environmental Artist", category: "Activism", duration: "53 min", date: "Mar 2026", thumbnail: "/images/about_art.png" },
  ...
  { ep: 47, title: "Packaging You Can Eat", description: "Edible and compostable materials for a plastic-free table.", guest: "Marie Eric", role: "Food-Tech Researcher", category: "Science", duration: "44 min", date: "Feb 2026", thumbnail: "/images/about_art.png" },
  ...
  { ep: 45, title: "Building a Brand With a Purpose", description: "Growing a mission-led business without losing the mission.", guest: "Maddie Hamann", role: "Founder, Pacha", category: "Business", duration: "42 min", date: "Jan 2026", thumbnail: "/images/about_art.png" },
  ...
  { ep: 43, title: "Tackling Plastic Pollution With Art & Activism", description: "Building a global movement against plastic waste.", guest: "Dianna Cohen", role: "CEO, Plastic Pollution Coalition", category: "Activism", duration: "51 min", date: "Dec 2025", thumbnail: "/images/about_art.png" },
  ...
  { ep: 41, title: "Certifiably Compostable", description: "What certification really means for compostable products.", guest: "Susan Thoman", role: "Compost Manufacturing Alliance", category: "Environment", duration: "43 min", date: "Nov 2025", thumbnail: "/images/about_art.png" },
];

      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-24">
          <div className="max-w-xl space-y-4 text-center lg:text-left">
            <h2 className="text-4xl md:text-6xl font-serif text-[#038f90] tracking-tighter leading-tight">
          ...
          <div className="w-full max-w-md">
            <form
              ...
              className="relative flex flex-row gap-2 p-1.5 md:p-2 bg-[#038f90]/5 backdrop-blur-sm rounded-2xl md:rounded-full border border-[#038f90]/20 shadow-xl items-center"
            >
              <input
                type="email"
                placeholder="yourname@email.com"
                className="flex-1 px-4 py-3 md:px-6 md:py-4 rounded-xl md:rounded-full bg-white text-[#038f90] font-sans text-xs md:text-sm focus:outline-none focus:ring-2 focus:ring-[#038f90]/20 transition-all placeholder:text-[#038f90]/30 min-w-0"
                required
              />
              <Button
                variant="accent"
                className="!px-4 md:!px-8 !h-10 md:!h-14 !text-[10px] md:!text-sm uppercase tracking-widest whitespace-nowrap !rounded-xl md:!rounded-full shrink-0 bg-[#038f90] !text-white shadow-xl"
              >
                Subscribe Now
              </Button>
            </form>

            <p className="mt-4 text-[10px] md:text-xs text-[#038f90]/40 text-center lg:text-left">
